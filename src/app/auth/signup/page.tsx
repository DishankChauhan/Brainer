...
import { Eye, EyeOff, Mail, Lock, Chrome, Twitter, Gamepad2, CheckCircle, User } from 'lucide-react'
    ...
    <div className="min-h-screen bg-black flex items-center justify-center relative overflow-hidden px-4">
      ...
      <div className="relative z-20 p-8 rounded-2xl backdrop-blur-sm bg-black/50 border border-white/10 max-w-md w-full">
          ...
          <div className="text-white/80 flex flex-col items-center space-y-1">
            <span className="relative group cursor-default">
              ...
              <span className="relative inline-block animate-pulse">
                {isPaidUser ? 'Complete Your Pro Account' : 'Build your digital brain'}
              </span>
            </span>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          >
            {isSubmitting ? 'Creating Brain...' : 'Create Brainer Account'}
          </button>
        </form>
        ...
        <div className="mt-8">
          ...
          <div className="mt-6 grid grid-cols-3 gap-3">
            <SocialButton icon={<Chrome size={18} />} name="Chrome" onClick={handleGoogleSignUp} />
        ...
        <p className="mt-8 text-center text-sm text-white/60">
          ...
          <Link href="/auth/signin" className="font-medium text-white hover:text-purple-300 transition-colors">
            Sign In
          </Link>
        </p>
      </div>
