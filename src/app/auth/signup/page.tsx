...
export default function SignUp() {
  ...
  return (
    <div className="min-h-screen w-screen bg-[#111111] relative overflow-hidden flex items-center justify-center py-8">
        ...
        >
          <div className="relative group">
            ...
            <div className="absolute -inset-[1px] rounded-2xl overflow-hidden">
              ...
              {/* Other light beams - similar to signin */}
              <motion.div 
            ...
            <div className="relative bg-black/40 backdrop-blur-xl rounded-2xl p-6 border border-white/[0.05] shadow-2xl overflow-hidden">
              ...
              <div className="text-center space-y-1 mb-5">
                ...
                >
                  Start your memory-preserving journey
                </motion.p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <motion.div className="space-y-3">
                  ...
                  >
                    ...
                    <div className="relative flex items-center overflow-hidden rounded-lg">
                      <Lock className={`absolute left-3 w-4 h-4 transition-all duration-300 ${
                        focusedInput === "confirmPassword" ? 'text-indigo-400' : 'text-white/40'
                      }`} />
                ...
                <div className="flex items-start space-x-2 pt-1">
                  ...
                  <label htmlFor="agree-terms" className="text-xs text-white/60 leading-relaxed">
                    I agree to the{' '}
                    <Link href="/terms" className="text-indigo-400 hover:text-indigo-300 transition-colors duration-200">
                      Terms of Service
                    </Link>
                    {' '}and{' '}
                    <Link href="/privacy" className="text-indigo-400 hover:text-indigo-300 transition-colors duration-200">
                      Privacy Policy
                    </Link>
                  </label>
                </div>
                ...
                >
                  ...
                  <div className={`relative overflow-hidden ${agreeToTerms ? 'bg-indigo-600 hover:bg-indigo-500' : 'bg-gray-600 cursor-not-allowed'} text-white font-medium h-10 rounded-lg transition-all duration-300 flex items-center justify-center`}>
                    <motion.div 
                ...
                >
                  ...
                  >
                    <span className="relative z-10 text-indigo-400 group-hover/signin:text-indigo-300 transition-colors duration-300 font-medium">
                      Sign in
                    </span>
                    <span className="absolute bottom-0 left-0 w-0 h-[1px] bg-indigo-400 group-hover/signin:w-full transition-all duration-300" />
                  </Link>
                </motion.p>
              </form>
            </div>
