...
export const PinContainer = ({
  ...
  // If href is provided, render as Link, otherwise as div
  if (href && href !== "#") {
    return (
      <Link
        className={cn(
      ...
      >
        ...
        >
          <div
            ...
            className="absolute left-1/2 p-4 top-1/2 flex justify-start items-start rounded-2xl shadow-[0_8px_16px_rgb(0_0_0/0.4)] bg-gray-900 border border-gray-700/50 group-hover/pin:border-indigo-500/50 transition duration-700 overflow-hidden"
          >
  ...
  // For non-link containers (href="#" or no href)
  return (
    <div
      className={cn(
        "relative group/pin z-50 cursor-pointer",
    ...
    <motion.div className="pointer-events-none w-96 h-80 flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition duration-500">
      <div className="w-full h-full -mt-7 flex-none inset-0">
        <div className="absolute top-0 inset-x-0 flex justify-center">
          <div className="relative flex space-x-2 items-center z-10 rounded-full bg-gray-900 py-0.5 px-4 ring-1 ring-indigo-500/20">
